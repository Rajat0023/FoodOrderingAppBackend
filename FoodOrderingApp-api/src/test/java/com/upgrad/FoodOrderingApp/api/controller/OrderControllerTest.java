...
public class OrderControllerTest {
    ...
    //This test case passes when you have handled the exception of trying to save an order while your session is already expired.
    ...
    //This test case passes when you have handled the exception of trying to save an order while the payment id you gave for making the payment does not exist in the database.
    ...
    public void shouldGetPlacedOrderDetails() throws Exception {
        ...
        Assert.assertEquals(customerOrderResponse.getOrders().size(), 1);
        Assert.assertEquals(customerOrderResponse.getOrders().get(0).getId().toString(), orderEntity.getUuid());
        Assert.assertEquals(customerOrderResponse.getOrders().get(0).getId().toString(), orderEntity.getUuid());
        Assert.assertEquals(customerOrderResponse.getOrders().get(0).getCustomer().getId().toString(), orderEntity.getCustomer().getUuid());
        Assert.assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getId().toString(), orderEntity.getAddress().getUuid());
        Assert.assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getState().getId().toString(), orderEntity.getAddress().getState().getUuid());
